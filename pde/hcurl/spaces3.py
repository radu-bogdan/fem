...
def spaceInfo(MESH,space):
    ...
    if space == 'N0':
        ...
        LISTS['N0']['TET']['qp_we_M'] = quadrature.keast(order = 2)
        LISTS['N0']['TET']['qp_we_Mh'] = quadrature.keast(order = 1)
        LISTS['N0']['TET']['qp_we_K'] = quadrature.keast(order = 0)
        
        LISTS['N0']['TET']['sizeM'] = MESH.NoEdges
        ...
        LISTS['N0']['TET']['LIST_DOF'] = MESH.TetsToEdges
