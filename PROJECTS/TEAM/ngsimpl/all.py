...
for deg in range(1,5):
    ...
    HcurlCoil = ngs.HCurl(mesh, order = degj, dirichlet = "coil_outer|coil_inner|coil_up|coil_down", definedon = 'coil', nograds = True)
    TotalCurrent = 1000
    print(TotalCurrent)
    coil_depth = 0.1
    ...
    Hcurl = ngs.HCurl(mesh, order = degj, nograds = True, dirichlet = 'ambient_face')
    u,v = Hcurl.TnT()
    ...
    if doarr[0]==1:
        ...
        for it in range(1,maxit+1):
            ...
            if len(iterativeSolver.residuals) == maxit: print("... Failure! MaxIt Reached1!")
            # print(f"Number of iterations = {iterativeSolver.iterations}/{maxit} | Residual = {iterativeSolver.residuals[-1]}")
            tm2 = toc()
    ...
    if doarr[1]==1:
        ...
        with ngs.TaskManager():
            ...
            for it in range(1,maxit+1):
                ...
                if len(iterativeSolver.residuals) == maxit: print("... Failure! MaxIt Reached2!")
                # print(f"Number of iterations = {iterativeSolver.iterations}/{maxit} | Residual = {iterativeSolver.residuals[-1]}")
                tm2 = toc()
    ...
    if doarr[2]==1:
        ...
        for it in range(1,maxit+1):
            ...
            if len(iterativeSolver.residuals) == maxit: print("... reached maxit! 3")
            # print(f"Number of iterations = {iterativeSolver.iterations}/{maxit} | Residual = {iterativeSolver.residuals[-1]}")
            tm2 = toc()
