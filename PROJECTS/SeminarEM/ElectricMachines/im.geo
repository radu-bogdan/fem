...
Circle(30803) = {0, 0.1, 0, 0.5, 0, 2*Pi};
//+
Recursive Delete {
  Curve{30803}; 
}
//+
Cone(1) = {0, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(2) = {0.3, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(3) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(4) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(5) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(6) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(7) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(8) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
//+
Cone(9) = {0.4, -0.1, -0, 1, 0, 0, 0.5, 0.1, 2*Pi};
