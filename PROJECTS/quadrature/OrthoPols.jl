...
# function kjacopols2(x::BigFloat, a::BigFloat, b::BigFloat, n::Int)
#     pols = zeros(BigFloat, n+1)
#     ders = zeros(BigFloat, n+1)
...
# function klegeypols3(x::BigFloat, y::BigFloat, n::Int)
#     pols = zeros(BigFloat, n + 1)
#     dersx = zeros(BigFloat, n + 1)
#     dersy = zeros(BigFloat, n + 1)
...
# function ortho2eva30(mmax::Int, z::Vector{BigFloat})
#     # Constants
#     zero = BigFloat(0)
#     sqrt2 = sqrt(BigFloat(2))
#     sqrt3 = sqrt(BigFloat(3))
#     r11 = BigFloat(-1) / 3
#     r12 = BigFloat(-1) / sqrt3
#     r21 = BigFloat(-1) / 3
#     r22 = BigFloat(2) / sqrt3
...
#     f2 = zeros(BigFloat, mmax+1, mmax+1)
#     f5 = zeros(BigFloat, mmax+1, mmax+1)
#     for m in 0:mmax
#         par1 = BigFloat(2 * m + 1)
#         temp_f2, temp_f5 = kjacopols2(b, par1, zero, mmax - m)
#         f2[1:length(temp_f2), m+1] = temp_f2
...
#     pols = zeros(BigFloat, div((mmax + 1) * (mmax + 2), 2))
#     dersx = zeros(BigFloat, div((mmax + 1) * (mmax + 2), 2))
#     dersy = zeros(BigFloat, div((mmax + 1) * (mmax + 2), 2))
...
# function ortho2eva3(mmax::Int, z::Vector{BigFloat})
#     # Check if z has exactly 2 elements
#     @assert length(z) == 2 "z must be a vector of length 2"

#     # Constants
#     c0 = BigFloat(1) / sqrt(BigFloat(3)) * sqrt(sqrt(BigFloat(3)))
#     c1 = sqrt(BigFloat(2)) * sqrt(sqrt(BigFloat(3)))
#     c2 = sqrt(BigFloat(2)) * sqrt(sqrt(BigFloat(3)))
...
#     elseif mmax == 1
#         pols = [c0, z[1] * c1, z[2] * c2]
#         dersx = [BigFloat(0), c1, BigFloat(0)]
#         dersy = [BigFloat(0), BigFloat(0), c2]
#     else
#         pols, dersx, dersy = ortho2eva30(mmax, z)
#     end
