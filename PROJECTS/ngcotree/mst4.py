...
# undirected graph, with edges provided as pairs
...
class Graph: 
    ...
    # Function to add edges to the graph from a list of pairs
    def addEdges(self, edge_pairs): 
        # Each pair in edge_pairs represents an edge
...
if __name__ == '__main__': 
    g = Graph(4)
    edge_pairs = [[0, 1], [0, 2], [0, 3], [1, 3], [2, 3]]  # Example list of edge pairs
    g.addEdges(edge_pairs)
