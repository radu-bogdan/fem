...
def update_left(ux,uy):
    ...
    fxx_grad_u_Kxx = Kx @ D0 @ sps.diags(fxx(ux,uy))@ Kx.T
    fyy_grad_u_Kyy = Ky @ D0 @ sps.diags(fyy(ux,uy))@ Ky.T
    fxy_grad_u_Kxy = Ky @ D0 @ sps.diags(fxy(ux,uy))@ Kx.T
    fyx_grad_u_Kyx = Kx @ D0 @ sps.diags(fyx(ux,uy))@ Ky.T
